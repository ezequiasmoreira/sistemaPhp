...
<div class="container">
        ...
        <form action= {{ url("funcionario/salvar") }} method="Post">
            ...
            <button type="submit" id="cadastrarFuncionario" class="btn btn-default">Cadastrar</button>
        </form>
  </div>
  @include('localizacao.endereco.modalCadastro') 
  @include('localizacao.endereco.modalCadastroJs')
  @include('pessoa.funcionario.createJs')
  @endsection
